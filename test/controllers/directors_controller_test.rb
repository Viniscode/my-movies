...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { birthdate: @director.birthdate, country: @director.country, gender: @director.gender, name: @director.name, type: @director.type }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { birthdate: @director.birthdate, country: @director.country, gender: @director.gender, name: @director.name, type: @director.type }
    assert_redirected_to director_path(assigns(:director))
  end
